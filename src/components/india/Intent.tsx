    ...
    <div className="fixed inset-0 z-[60] bg-[#070c1a] text-white overflow-y-auto">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mt-20">
          ...
          <p className="text-white/50 mb-8 max-w-2xl">
            One system at a time, at full depth, until the answer to &quot;how should this work in India?&quot;
        ...
        <section className="mt-20">
          ...
          <p className="text-white/50 mb-8 max-w-2xl">
            &quot;Blockchain&quot; ships three separate properties as one package, and almost no use case needs
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-4">
              <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                <div className="mb-2 font-semibold">Don&apos;t think crypto</div>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                ...
                <p className="text-sm leading-relaxed text-white/50">
                  ...
                  threshold signing, because a national issuing key cannot live where this prototype&apos;s does.
